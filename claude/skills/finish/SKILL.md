...
2. **Resolve or create the DevRev issue.**
   ...
   - If an existing DevRev reference was provided, skip issue creation and use that reference as the issue link for `commit`.
   - If no DevRev reference was provided:
