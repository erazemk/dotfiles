...
Fetch and extract readable content from web pages as markdown, or download images.

## Usage

```bash
scripts/visit.py <url>
```
...
scripts/visit.py https://example.com/article

# Fetch documentation
scripts/visit.py https://docs.python.org/3/library/asyncio.html

# Download an image (auto-detected by content-type)
scripts/visit.py https://example.com/image.png
