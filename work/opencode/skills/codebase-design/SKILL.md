...
description: Module and interface design, seams, adapters, testability, and deepening. Use proactively for architecture refactors, design alternatives, or whenever a task needs a module interface to be designed or improved.
---
