---
name: pr
description: Open a GitHub pull request following DevRev conventions. Run after using the commit skill.
---

## PR

Open a GitHub pull request using DevRev's PR conventions. This skill should be run after the changes have been committed (e.g. after using `/commit`).
...
3. Show the user the PR title and body, and ask for approval before creating it. If an ask/question tool is available, present the PR details in the question text and offer these options:
   - "Yes" — create the PR
